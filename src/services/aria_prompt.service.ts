...
export const getEmotionalRegister = (healthScore?: number, recentGrowth: number = 0) => {
...
export const buildARIASystemPrompt = ({
  ...
  const primaryPlatform = user?.primary_platform || (user as any)?.primaryPlatform || 'instagram'
